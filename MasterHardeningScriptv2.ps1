...
Write-Host "Enter ports for active services (e.g., 80, 445, 3389)."
...
Write-Host "Example: DNS, RemoteRegistry, Spooler (Do NOT list LanmanServer if using 445)"
...
Write-Host "Production ports 80/445/RDP are restricted to your list."
